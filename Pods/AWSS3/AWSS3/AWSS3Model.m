...
+ (NSValueTransformer *)locationConstraintJSONTransformer {
    return [AWSMTLValueTransformer reversibleTransformerWithForwardBlock:^NSNumber *(NSString *value) {
        ...
        if ([value caseInsensitiveCompare:@"cn-beijing-1"] == NSOrderedSame) {
            return @(AWSS3BucketLocationConstraintCNBeijing1);
        }
        if ([value caseInsensitiveCompare:@"cn-beijing-2"] == NSOrderedSame) {
            return @(AWSS3BucketLocationConstraintCNBeijing2);
        }
        if ([value caseInsensitiveCompare:@"cn-hunang-1"] == NSOrderedSame) {
            return @(AWSS3BucketLocationConstraintCNhunang1);
        }
        ...
        switch ([value integerValue]) {
            ...
            case AWSS3BucketLocationConstraintCACentral1:
                return @"ca-central-1";
            case AWSS3BucketLocationConstraintCNBeijing1:
                return @"beijing1";
            case AWSS3BucketLocationConstraintCNBeijing2:
                return @"beijing2";
            case AWSS3BucketLocationConstraintCNhunang1:
                return @"hunang1";
            default:
                return nil;
        }
